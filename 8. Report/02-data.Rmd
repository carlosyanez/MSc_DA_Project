...
-   use *Hierarchical Density-Based Spatial Clustering of Applications with Noise* (HDBSCAN) [@campello2013], a density-based hierarchical clustering algorithm.
...
p <- dataset |>
  ...
  pivot_longer(cols=-c(DivisionNm,cluster),names_to = "Attribute",values_to="Value") |>
