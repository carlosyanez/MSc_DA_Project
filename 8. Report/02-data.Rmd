...
-   The **Australian Electoral Commission** (AEC, \<<https://www.aec.gov.au/>\> ). The national body overseeing and running federal elections, the AEC contains detailed election result records. All results for federal elections held in the 21st century are available online, through their Tally Room website [@TallyRoom].
...
Although this project's scope is data analysis, writing this three packages was a significant task, requiring as large time investment. Appendix \@ref(appendix-packages) presents a more detailed view on their design principles. Additionally appendices \@ref(auspol-vignette), \@ref(auscensus-vignette), and \@ref(aussiemaps-vignette) contain a copy of some of their vignettes explaining their use. With their help, it was possible to build a basic data extraction and transformation pipeline, which is represented by figure \@ref(fig:data-flow2).
...
Considering the census data available and selecting the elections closer to each census, four sets of events were selected for data extraction. They are presented in table \@ref(tab:selected-pairs).
...
[^1]: In Queensland and the Northern Territory, the Liberal and National branches have merged. Elected federal MPs and senators sit with Liberals if they come from an urban area, or the Nationals when they represent a regional/rural/remote electorate.

[^2]: In Queensland and the Northern Territory, the Liberal and National branches have merged. Elected federal MPs and senators sit with Liberals if they come from an urban area, or the Nationals when they represent a regional/rural/remote electorate.
...
[^3]: *02 -Selected Medians and Averages*

[^4]: *09 - Country of Birth of Person by Age by Sex*
...
A sample of the resulting dataset is present in table \@ref(tab:datasetsample). A detailed list of all variables is presented in appendix \@ref(appendix-variables).
