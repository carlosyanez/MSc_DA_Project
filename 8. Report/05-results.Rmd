...
wentworh <- compare_results("Wentworth",parties=4,results=results)
...
plot_grid(p,ncol=2,nrow=2,titletext = "Census attributes in teal seats")    & theme(legend.position = "bottom")   
...
plot_grid(p,ncol=2,nrow=2,titletext = "Census attributes selected in Green strongholds")   & theme(legend.position = "bottom")  
...
plot_grid(p,ncol=2,nrow=2,titletext = "Suburban electorates")  & theme(legend.position = "bottom")  
