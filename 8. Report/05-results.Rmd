...
demographic_data <- dataset |> 
        ...
        select(-Metro,-StateAb,-election_year) |>
         pivot_longer(cols=-c(DivisionNm,Year,cluster),
...
-   In **Fowler** (NSW) [@fowlerresults], an independent candidate altered Labor's trend. In this case, a community-based candidate captured the multicultural vote from a "parachuted" Labor nominee - which is a variable not considered in the model. [@https://www.abc.net.au/news/catherine-hanrahan/79018522022]
-   In the case of **Kingston (SA) [@kingstonresults]**, it seems more difficult to explain the results by effect of demographic changes.
