...
saveRDS(extract_fit_parsnip(nnet_model),path(clustering_folder,"clustering_nnet.rds"))
saveRDS(extract_fit_parsnip(rpart_model),path(clustering_folder,"clustering_rpart.rds"))
saveRDS(extract_fit_parsnip(ranger_model),path(clustering_folder,"clustering_ranger.rds"))
saveRDS(extract_fit_parsnip(naive_model),path(clustering_folder,"clustering_naive.rds"))
