...
saveRDS(extract_fit_parsnip(ranger_model),path(clustering_folder,"clustering_ranger_redux_2.rds"))
saveRDS(extract_fit_parsnip(rpart_model),path(clustering_folder,"clustering_rpart_redux_2.rds"))
