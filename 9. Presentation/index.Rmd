...
```{r out.height='500px'}
  ...
  htmlwidgets::saveWidget(ply,here("reg1.html"),libdir = "lib")

```

<embed type="text/html" src="reg1.html" height="500" width="580">
]
...
htmlwidgets::saveWidget(interactive_plot(p),here("forecast2022.html"),libdir = "lib")

```

<embed type="text/html" src="forecast2022.html" height="500" width="600">
...
htmlwidgets::saveWidget(ply,here("goldstein1.html"),libdir = "lib")
```
...
htmlwidgets::saveWidget(ply,here("goldstein2.html"),libdir = "lib")

```

<embed type="text/html" src="goldstein1.html" height="220" width="600"><br>
<embed type="text/html" src="goldstein2.html" height="250" width="600">
...
htmlwidgets::saveWidget(ply,here("wills1.html"),libdir = "lib")
...
htmlwidgets::saveWidget(ply,here("wills2.html"),libdir = "lib")

```

<embed type="text/html" src="wills1.html" height="220" width="600"><br>
<embed type="text/html" src="wills2.html" height="250" width="600">
...
htmlwidgets::saveWidget(ply,here("menzies1.html"),libdir = "lib")
...
htmlwidgets::saveWidget(ply,here("menzies2.html"),libdir = "lib")

```

<embed type="text/html" src="menzies1.html" height="220" width="600"><br>
<embed type="text/html" src="menzies2.html" height="250" width="600">
...
htmlwidgets::saveWidget(ply,here("vip.html"),libdir = "lib")

```

<embed type="text/html" src="vip.html" height="500" width="1000">
...
```{r out.height='500px'}
 ...
 ply<- p_regression[[2]] |> 
  ...
  htmlwidgets::saveWidget(ply,here("reg2.html"),libdir = "lib")

```

<embed type="text/html" src="reg2.html" height="500" width="600">
...
```{r out.height='500px'}
 ...
 ply<- p_regression[[3]] |> 
  ...
  htmlwidgets::saveWidget(ply,here("reg3.html"),libdir = "lib")

```

<embed type="text/html" src="reg3.html" height="500" width="600">
...
htmlwidgets::saveWidget(ply,here("wentworth1.html"),libdir = "lib")
...
htmlwidgets::saveWidget(ply,here("wentworth2.html"),libdir = "lib")

```

<embed type="text/html" src="wentworth1.html" height="220" width="600"><br>
<embed type="text/html" src="wentworth2.html" height="250" width="600">
...
htmlwidgets::saveWidget(ply,here("ryan1.html"),libdir = "lib")
...
htmlwidgets::saveWidget(ply,here("ryan2.html"),libdir = "lib")

```

<embed type="text/html" src="ryan1.html" height="220" width="600"><br>
<embed type="text/html" src="ryan2.html" height="250" width="600">
]
...
htmlwidgets::saveWidget(ply,here("newcastle1.html"),libdir = "lib")
...
htmlwidgets::saveWidget(ply,here("newcastle2.html"),libdir = "lib")

```

<embed type="text/html" src="newcastle1.html" height="220" width="600"><br>
<embed type="text/html" src="newcastle2.html" height="250" width="600">
