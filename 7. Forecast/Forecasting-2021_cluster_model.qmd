...
output$prediction_compared <- prediction_compared
output$newspoll <- primary_vote
output$classification_model <- classification_model
output$regression_models <- regression_models


saveRDS(output,here("7. Forecast","results.rds"))
```
